...
const Projects = () => {
  return (
    ...
    >
      ...
      <div className="w-[90%] lg:max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-center mt-15 gap-10">
        {/* left */}
        <div className="w-full lg:w-[40%] border-2 border-purple-600 rounded-md p-2 flex flex-col justify-start items-start gap-5 hover:scale-105 transition-all duration-500 mb-10">
